...
class Log:
    ...
    def dbg(self, msg: any, **kwargs) -> None:
        self._print(self.LEVEL_DBG, msg, **kwargs)

    def inf(self, msg: any, **kwargs) -> None:
        self._print(self.LEVEL_INF, msg, **kwargs)

    def wrn(self, msg: any, **kwargs) -> None:
        self._print(self.LEVEL_WRN, msg, **kwargs)

    def err(self, msg: any, **kwargs) -> None:
        self._print(self.LEVEL_ERR, msg, **kwargs)

    def imp(self, msg: any, **kwargs) -> None:
        self._print(self.LEVEL_IMP, msg, **kwargs)
